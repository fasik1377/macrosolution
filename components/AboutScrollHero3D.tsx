  ...
  return (
    <section ref={sectionRef} className="relative min-h-[250vh] overflow-hidden text-white">
      <div className="sticky top-0 flex min-h-screen items-center overflow-hidden bg-[#0096FF] pt-28">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_16%_18%,rgba(255,255,255,0.16),transparent_22%),radial-gradient(circle_at_82%_20%,rgba(125,211,252,0.22),transparent_20%),radial-gradient(circle_at_76%_74%,rgba(14,165,233,0.18),transparent_30%),linear-gradient(135deg,#46b7ff_0%,#0096FF_34%,#0a8be8_68%,#59c2ff_100%)]" />
