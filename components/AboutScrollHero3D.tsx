...
export default function AboutScrollHero3D({ title, description }: { title: string; description: string }) {
  ...
  const panelRotateY = useTransform(scrollYProgress, [0, 0.5, 1], [-16, 0, 10]);
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[250vh] overflow-hidden text-white">
      <div className="sticky top-0 flex min-h-screen items-center overflow-hidden bg-dark-header pt-28">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_16%_18%,rgba(77,159,255,0.2),transparent_24%),radial-gradient(circle_at_82%_74%,rgba(11,94,215,0.26),transparent_30%),linear-gradient(135deg,#001329_0%,#083B8A_48%,#001B47_100%)]" />
        <motion.div
          aria-hidden="true"
        ...
        <div className="container relative z-10 mx-auto grid min-h-[620px] items-center gap-12 px-6 lg:grid-cols-[0.9fr_1.1fr]">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <p className="font-semibold uppercase tracking-[0.28em] text-cyan-300">About Macro Solution</p>
            <h1 className="mt-6 text-3xl font-bold leading-[1.08] md:text-5xl lg:text-6xl">{title}</h1>
          ...
          <div className="relative h-[620px] [perspective:1800px]">
            ...
            >
              ...
              <div className="relative flex h-full flex-col justify-between [transform:translateZ(26px)]">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.32em] text-cyan-200/82">Identity Motion Layer</p>
                  <h3 className="mt-5 text-3xl font-bold">Partnership, Innovation, and Long-Term Growth</h3>
