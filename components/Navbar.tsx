    ...
    <header className="fixed left-0 top-0 z-50 w-full">
      <div className="relative mx-auto flex w-full max-w-[1600px] items-center justify-between px-4 py-4 md:px-6">
        <motion.div
          ...
          className="relative z-10 [backface-visibility:hidden] [perspective:1100px] [transform:translateZ(0)]"
        >
          {!isMobile && (
            <>
              <motion.div
          ...
          >
            ...
            >
              <Image
                ...
                height={86}
                priority
                className="h-14 w-14 object-contain brightness-[0.82] contrast-[1.38] saturate-[1.12] drop-shadow-[0_8px_18px_rgba(8,59,138,0.22)] [backface-visibility:hidden] md:h-[4.5rem] md:w-[4.5rem] md:drop-shadow-[0_10px_28px_rgba(8,59,138,0.28)]"
              />
            </motion.span>
          </Link>
        </motion.div>
