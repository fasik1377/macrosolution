  ...
  return (
    <div aria-hidden="true" className={`pointer-events-none ${frameClass} overflow-hidden ${className}`}>
      ...
      <motion.div
        ...
        className="absolute left-[12%] top-[8%] h-[22rem] w-[22rem] rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.22),rgba(0,150,255,0.26)_38%,transparent_70%)] blur-3xl"
      />
      <motion.div
        animate={{ opacity: [0.2, 0.5, 0.2], scale: [1.08, 0.92, 1.08], rotate: [360, 180, 0] }}
        transition={{ duration: 16, repeat: Infinity, ease: "easeInOut" }}
        className="absolute bottom-[6%] right-[8%] h-[28rem] w-[28rem] rounded-full bg-[radial-gradient(circle,rgba(0,150,255,0.34),rgba(0,0,255,0.2)_42%,transparent_72%)] blur-3xl"
      />
      <motion.div
